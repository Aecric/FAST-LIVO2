...
def generate_launch_description():
    ...
    #Load parameters
    camera_lidar_config_cmd = os.path.join(config_file_dir, "lxcamera.yaml")
    camera_config_cmd = os.path.join(config_file_dir, "lxcamera_pinhole.yaml")
    ...
    lidar_config_arg = DeclareLaunchArgument(
        'avia_params_file',
        default_value=camera_lidar_config_cmd,
